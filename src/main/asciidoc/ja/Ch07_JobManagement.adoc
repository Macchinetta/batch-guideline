...
{SB}のリファレンス
http://docs.spring.io/spring-batch/trunk/reference/html/metaDataSchema.html#recommendationsForIndexingMetaDataTables[B.10 Recommendations for Indexing Meta Data Tables]
