...
{server5_url}/ArchitectureInDetail/DataAccessDetail/DataAccessMyBatis3.html#resulthandler[ResultHandlerの実装]を参照のこと。
...
Mapperインタフェースを利用してデータベースアクセスするうえでの{batch5_shortname}としての制約は<<Ch05_DBAccess_HowToUse_Input_MapperInterface>>を参照のこと。 +
