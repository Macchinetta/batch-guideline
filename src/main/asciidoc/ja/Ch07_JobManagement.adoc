...
[[Ch07_JobManagement_Overview_JobExecutionManagement_FixPerformanceProblem]]
[TIP]
.Spring BatchのバージョンアップによるJobRepositoryの性能問題の修正
====
Macchinetta Batch 2.2.0では、{SB} 4.2.xから加わった変更により、ジョブの起動時に{SB}が発行する
link:https://github.com/spring-projects/spring-batch/issues/3634[``JobRepository``へのSQLによる性能劣化]が発生する事がある。
この問題は{SB}側で対処され、{SB} 4.2.4および4.3.0で変更が取り込まれた。Macchinetta Batchでは2.2.1および2.3.0でこの変更が取り込まれている。

本件の対策として、Macchinetta Batch 2.2.0では「{SB}で対処されたlink:https://github.com/spring-projects/spring-batch/pull/3635/files[変更]を実装する」ことを推奨しているが、
Macchinetta Batch {revnumber-index}ではこの問題は発生しないため、対策は不要となる。
====
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup070101" class="JavaConfigTab" id="tabgroup070101_1" checked><label for="tabgroup070101_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup070101" class="XMLConfigTab" id="tabgroup070101_2"><label for="tabgroup070101_2" class="tab">XMLConfig</label>
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup070102" class="JavaConfigTab" id="tabgroup070102_1" checked><label for="tabgroup070102_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup070102" class="XMLConfigTab" id="tabgroup070102_2"><label for="tabgroup070102_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source,terminal]
...
チャンクモデルにおけるステップの終了コードの変更::
  ...
  ステップ終了時の処理として、StepExecutionListenerのafterStepメソッドもしくは@AfterStepアノテーションを付与したメソッドを実装し、
  任意のステップの終了コードを返却する。
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup070103" class="JavaConfigTab" id="tabgroup070103_1" checked><label for="tabgroup070103_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup070103" class="XMLConfigTab" id="tabgroup070103_2"><label for="tabgroup070103_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source,java]
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup070104" class="JavaConfigTab" id="tabgroup070104_1" checked><label for="tabgroup070104_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup070104" class="XMLConfigTab" id="tabgroup070104_2"><label for="tabgroup070104_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source,java]
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup070105" class="JavaConfigTab" id="tabgroup070105_1" checked><label for="tabgroup070105_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup070105" class="XMLConfigTab" id="tabgroup070105_2"><label for="tabgroup070105_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source,java]
...
* 具体的な設定・実装例についてはlink:{server5_url}/ArchitectureInDetail/GeneralFuncDetail/Logging.html#id8[ログメッセージの一元管理]を参照。
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup070106" class="JavaConfigTab" id="tabgroup070106_1" checked><label for="tabgroup070106_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup070106" class="XMLConfigTab" id="tabgroup070106_2"><label for="tabgroup070106_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source,java]
