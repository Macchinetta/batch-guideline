...
- https://docs.spring.io/spring-batch/docs/{spring_batch_version}/org/springframework/batch/item/file/builder/FlatFileItemReaderBuilder.html[クラス FlatFileItemReaderBuilder<T>]
- https://docs.spring.io/spring-batch/docs/{spring_batch_version}/org/springframework/batch/item/file/builder/FlatFileItemWriterBuilder.html[クラス FlatFileItemWriterBuilder<T>]
- https://docs.spring.io/spring-batch/docs/{spring_batch_version}/org/springframework/batch/item/file/builder/MultiResourceItemReaderBuilder.html[クラス MultiResourceItemReaderBuilder<T>]
- https://docs.spring.io/spring-batch/docs/{spring_batch_version}/org/springframework/batch/item/file/builder/MultiResourceItemWriterBuilder.html[クラス MultiResourceItemWriterBuilder<T>]
- https://docs.spring.io/spring-batch/docs/{spring_batch_version}/org/springframework/batch/item/xml/builder/StaxEventItemReaderBuilder.html[クラス StaxEventItemReaderBuilder<T>]
- https://docs.spring.io/spring-batch/docs/{spring_batch_version}/org/springframework/batch/item/xml/builder/StaxEventItemWriterBuilder.html[クラス StaxEventItemWriterBuilder<T>]
