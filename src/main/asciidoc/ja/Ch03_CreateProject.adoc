...
* https://spring.pleiades.io/spring-framework/reference/core/beans/dependencies/factory-properties-detailed.html#beans-p-namespace[p-namespaceを使用したXMLショートカット]
* https://spring.pleiades.io/spring-framework/reference/core/beans/dependencies/factory-properties-detailed.html#beans-c-namespace[c-namespaceを使用したXMLショートカット]
...
* https://spring.pleiades.io/spring-batch/reference/job/java-config.html[Java構成]
* https://spring.pleiades.io/spring-batch/docs/current/org/springframework/batch/core/configuration/support/DefaultBatchConfiguration.html[クラス DefaultBatchConfiguration]
