...
:server5_url: https://macchinetta.github.io/server-guideline/1.11.1.RELEASE/ja
...
:terabom_fullname: TERASOLUNA Framework for Java (5.x) Dependencies
...
:spring_fw_version: 6.2.15
:spring_batch_version: 5.2.4
