...
中断したジョブの再実行方法についての詳細は、<<Ch06_ReProcessing.adoc#Ch06_RerunRestart,処理の再実行>>を参照。
...
ItemReaderでのスキップ::
  ``StepBuilderのskipPolicyメソッド/<batch:chunk>のskip-policy属性``にスキップ方法を指定する。
  ``skipメソッド/<batch:skippable-exception-classes>``に、スキップ対象とするItemReaderで発生する例外クラスを指定する。 +
  ``skipPolicyメソッドの引数skipPolicy/skip-policy属性``には、{SB}が提供している下記に示すいづれかのクラスを使用する。
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup060201" class="JavaConfigTab" id="tabgroup060201_1" checked><label for="tabgroup060201_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup060201" class="XMLConfigTab" id="tabgroup060201_2"><label for="tabgroup060201_2" class="tab">XMLConfig</label>
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup060202" class="JavaConfigTab" id="tabgroup060202_1" checked><label for="tabgroup060202_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup060202" class="XMLConfigTab" id="tabgroup060202_2"><label for="tabgroup060202_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
|(2)
|``StepBuilderのskipPolicyメソッド/<batch:chunk>のskip-policy属性``に(1)で定義したBeanを設定する。
|===
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup060209" class="JavaConfigTab" id="tabgroup060209_1" checked><label for="tabgroup060209_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup060209" class="XMLConfigTab" id="tabgroup060209_2"><label for="tabgroup060209_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup060203" class="JavaConfigTab" id="tabgroup060203_1" checked><label for="tabgroup060203_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup060203" class="XMLConfigTab" id="tabgroup060203_2"><label for="tabgroup060203_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
``StepBuilderのskipPolicyメソッド/skip-policy属性``省略時のデフォルトであるため、定義しなくてもよい。

|(2)
|``StepBuilderのskipLimitメソッド/<batch:chunk>のskip-limit属性``にスキップ数の上限値を設定する。 +
``skipPolicyメソッド/skip-policy属性``はデフォルトを使用ため省略。
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup060204" class="JavaConfigTab" id="tabgroup060204_1" checked><label for="tabgroup060204_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup060204" class="XMLConfigTab" id="tabgroup060204_2"><label for="tabgroup060204_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
|(2)
|``policyMap``に、キーを例外クラス、値をスキップ方法にしたマップを設定する。 +
...
ItemProcessorでのスキップ::
    ...
    詳細は、<<Ch06_ExceptionHandling_Appendix_SkippableExceptionClasses>>を参照。

[IMPORTANT]
.ItemProcessorにおける例外ハンドリンクの制約
====
<<Ch06_ExceptionHandling_Appendix_SkippableExceptionClasses>>にあるように、
ItemProcessorでは、``skipメソッド/<batch:skippable-exception-classes>``を利用したスキップは禁止している。
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup060205" class="JavaConfigTab" id="tabgroup060205_1" checked><label for="tabgroup060205_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup060205" class="XMLConfigTab" id="tabgroup060205_2"><label for="tabgroup060205_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
<<Ch06_ExceptionHandling_HowToUse_ContinuationPropriety_Skip_Chunk_LimitCheckingItemSkipPolicy,LimitCheckingItemSkipPolicy>>をもとに、スキップの実装例を示す。
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup060206" class="JavaConfigTab" id="tabgroup060206_1" checked><label for="tabgroup060206_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup060206" class="XMLConfigTab" id="tabgroup060206_2"><label for="tabgroup060206_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
<<Ch06_ExceptionHandling_HowToUse_ContinuationPropriety_Retry>>をもとに、リトライの実装例を示す。

.Bean定義
// ============ Java/XML Config Tab start. ============
++++
<div class="tabbox">
  <input type="radio" name="tabgroup060207" class="JavaConfigTab" id="tabgroup060207_1" checked><label for="tabgroup060207_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup060207" class="XMLConfigTab" id="tabgroup060207_2"><label for="tabgroup060207_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
その機能は、以下のように``StepBuilderのskipメソッド/<chunk>要素配下に<skippable-exception-classes>要素``を設定し、スキップ対象の例外を指定する形で実装する。

[source, xml]
.skip/<skippable-exception-classes>の使用例
// ============ Java/XML Config Tab start. ============
++++
<div class="tabbox">
  <input type="radio" name="tabgroup060208" class="JavaConfigTab" id="tabgroup060208_1" checked><label for="tabgroup060208_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup060208" class="XMLConfigTab" id="tabgroup060208_2"><label for="tabgroup060208_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
* ``skipメソッド/<skippable-exception-classes>要素``を利用して例外をスキップした場合、
...
よって、``skipメソッド/<skippable-exception-classes>``を使用することは推奨しない。
