...
尚、{SB} 4.3.0でMap-based JobRepository/JobExplorerは非推奨となった。 +
https://docs.spring.io/spring-batch/docs/current/reference/html/whatsnew.html[{SB}4.3/Deprecations] +
{SB}によるこの不具合報告の状況としては以下を参照されたい。 +
https://github.com/spring-projects/spring-batch/issues/3780[{SB}/BATCH-3780]
====
...
{SB}のリファレンス
https://docs.spring.io/spring-batch/docs/{spring_batch_version}/reference/html/schema-appendix.html#recommendationsForIndexingMetaDataTables[B.10 Recommendations for Indexing Meta Data Tables]
