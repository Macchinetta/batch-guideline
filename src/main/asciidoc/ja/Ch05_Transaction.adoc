...
[[Ch05_Transaction_Arch_UnderSpringBatch_ChunkModel]]
...
https://github.com/spring-projects/spring-batch/issues/2930[{SB}/BATCH-647] +
...
[[Ch05_Transaction_Arch_UnderSpringBatch_TaskletModel]]
...
一括コミット方式では、{SB}がタスクレット起動時に開始されるトランザクション制御の仕組みをそのまま利用する。 +
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup050101" class="JavaConfigTab" id="tabgroup050101_1" checked><label for="tabgroup050101_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup050101" class="XMLConfigTab" id="tabgroup050101_2"><label for="tabgroup050101_2" class="tab">XMLConfig</label>
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup050102" class="JavaConfigTab" id="tabgroup050102_1" checked><label for="tabgroup050102_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup050102" class="XMLConfigTab" id="tabgroup050102_2"><label for="tabgroup050102_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source,java]
...
|(1)
|``StepBuilderのchunkメソッドの引数transactionManager/<batch:tasklet>要素のtransaction-manager属性``に定義済みの``jobTransactionManager``を設定する。 +
ここに設定したトランザクションマネージャで中間コミット方式のトランザクションを制御する。

|(2)
|``StepBuilderのchunkメソッドの引数chunkSize/commit-interval属性``にチャンクサイズを設定する。この例では10件処理するごとに1回コミットが発行される。
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup050103" class="JavaConfigTab" id="tabgroup050103_1" checked><label for="tabgroup050103_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup050103" class="XMLConfigTab" id="tabgroup050103_2"><label for="tabgroup050103_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source,java]
...
|(1)
|``StepBuilderのtaskletメソッドの引数transactionManager/<batch:tasklet>要素のtransaction-manager属性``に定義済みの``jobTransactionManager``を設定する。 +
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup050104" class="JavaConfigTab" id="tabgroup050104_1" checked><label for="tabgroup050104_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup050104" class="XMLConfigTab" id="tabgroup050104_2"><label for="tabgroup050104_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source,java]
...
|(1)
|``StepBuilderのtaskletメソッドの引数transactionManager/<batch:tasklet>要素のtransaction-manager属性``に定義済みの``jobResourcelessTransactionManager``を設定する。
...
====
以下に示すジョブ定義のように、``StepBuilderのchunkメソッドの引数transactionManager/batch:taskletのtransaction-manager属性``は必須のため省略できない。

.TransactionManager設定箇所の抜粋
// ============ Java/XML Config Tab start. ============
++++
<div class="tabbox">
  <input type="radio" name="tabgroup050105" class="JavaConfigTab" id="tabgroup050105_1" checked><label for="tabgroup050105_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup050105" class="XMLConfigTab" id="tabgroup050105_2"><label for="tabgroup050105_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
``ResourcelessTransactionManager``は``LaunchContextConfig.java/launch-context.xml``に``jobResourcelessTransactionManager``として定義済みである。

.ResourcelessTransactionManagerの使用例
// ============ Java/XML Config Tab start. ============
++++
<div class="tabbox">
  <input type="radio" name="tabgroup050106" class="JavaConfigTab" id="tabgroup050106_1" checked><label for="tabgroup050106_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup050106" class="XMLConfigTab" id="tabgroup050106_2"><label for="tabgroup050106_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup050107" class="JavaConfigTab" id="tabgroup050107_1" checked><label for="tabgroup050107_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup050107" class="XMLConfigTab" id="tabgroup050107_2"><label for="tabgroup050107_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
** ItemProcessorは``delegates``属性に指定した順番に処理されることに留意する。
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup050108" class="JavaConfigTab" id="tabgroup050108_1" checked><label for="tabgroup050108_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup050108" class="XMLConfigTab" id="tabgroup050108_2"><label for="tabgroup050108_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
++++
<div class="tabbox">
  <input type="radio" name="tabgroup050109" class="JavaConfigTab" id="tabgroup050109_1" checked><label for="tabgroup050109_1" class="tab">JavaConfig</label>
  <input type="radio" name="tabgroup050109" class="XMLConfigTab" id="tabgroup050109_2"><label for="tabgroup050109_2" class="tab">XMLConfig</label>
  <div class="tabcontent" name="JavaConfigContent">
++++
// Java Config start.
[source, java]
...
尚、 https://github.com/spring-projects/spring-data-commons[spring-data-commons] 2.5.0で``ChainedTransactionManager``は非推奨であり、予告なく削除される場合があるため注意すること。 + 
https://docs.spring.io/spring-data/commons/docs/current/api/org/springframework/data/transaction/ChainedTransactionManager.html[spring-data-commons/ChainedTransactionManager]
